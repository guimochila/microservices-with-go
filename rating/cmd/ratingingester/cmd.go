...
func main() {
	fmt.Println("Creating a Kafka producter")
	...
	const topic = "ratings"
	if err := productRatingEvents(topic, producer, ratingEvents); err != nil {
		panic(err)
	}
...
func productRatingEvents(topic string, producer *kafka.Producer, ratingEvents []model.RatingEvent) error {
